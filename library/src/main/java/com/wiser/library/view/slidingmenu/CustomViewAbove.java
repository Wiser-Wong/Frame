...
public class CustomViewAbove extends ViewGroup {
	 ...
	 * through its first layout there will be a smooth animated transition between
	...
	/*
	 * public void setOnOpenListener(OnOpenListener l) { mOpenListener = l; } public
	 * void setOnCloseListener(OnCloseListener l) { mCloseListener = l; }
	 */
	 ...
	 * This method will be invoked when the current page is scrolled, either as part
	 * of a programmatically initiated smooth scroll or a user initiated touch
	 * scroll. If you override this method you must call through to the superclass
	 * implementation (e.g. super.onPageScrolled(position, offset, offsetPixels))
