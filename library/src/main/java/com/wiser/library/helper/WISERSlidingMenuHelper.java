 ...
 * @version 版本
 */
public class WISERSlidingMenuHelper {
	 ...
	 */
	public WISERSlidingMenuHelper(FragmentActivity activity) {
		mActivity = activity;
	}

	/**
	 * Sets mSlidingMenu as a newly inflated SlidingMenu. Should be called within
	 * the activitiy's onCreate()
	 */
	...
	/**
	 * Further SlidingMenu initialization. Should be called within the activitiy's
	 * onPostCreate()
	 *
...
//			throw new IllegalStateException("Both setLeftMenuViewLayoutId must be called " + "in onCreate in addition to setContentView.");
		}
	...
	/**
	 * Controls whether the ActionBar slides along with the above view when the menu
	 * is opened, or if it stays in place.
	 *
	...
	/**
	 * Set the behind view content to an explicit view. This view is placed directly
	 * into the behind view 's view hierarchy. It can itself be a complex view
	 * hierarchy.
	 *
	 * @param view
	 *            The desired content to display.
	 ...
	 */
	public void setLeftMenuViewLayoutId(View view, LayoutParams layoutParams) {
		mViewBehind = view;
	...
	/**
	 * Open the SlidingMenu and show the secondary menu view. Will default to the
