package com.wiser.library.interceptor;
...
public final class LogggingInterceptor implements Interceptor {
	...
	public LogggingInterceptor() {
        this(Logger.DEFAULT);
    }

	public LogggingInterceptor(Logger logger) {
        this.logger = logger;
    }
